...
void drink2::on_pushButton_clicked()
{
    QString line=stu_list.at(l);
    QStringList subs=line.split(" ");
...
void drink2::on_pushButton_2_clicked()
{
    this->close();
}
void drink2::writefile(){
...
void drink2::writetime(QString cnt){
    QFile file("time.txt");
